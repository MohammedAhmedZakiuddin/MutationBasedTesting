...
class Stmt extends BaseToken {
    ...
    switch (this.typeNumber) {
      ...
      case 1:
        ...
        for (Expr e: args) {
          list += e.toString() + ", "; // use
                                       // def
        } list = list.substring(0, list.length() > 0 ? list.length() - 2 : 0); // def
        return getTabs(depth) + id + "(" + list + ");"; // use
      case 2:
        String result = "";
        for (Fielddecl f: fielddecls) {
          result += f.toString(depth+1) + "\n";
        }
        //T13 = [1, 25, 26, 27, 28, 26, 27, 28, 26, 29, 30, 31, 32, 33, 31, 32, 33, 31, 34]
        for (Stmt st: stmts) {
  ...
  // Mutant ID 26
  public String toStringID26(int depth) {
    switch (this.typeNumber) {
      case 1:
        String list = ""; // def
        for (Expr e: args) {
  ...
  // Mutant ID 27
  public String toStringID27(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 28
  public String toStringID28(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 29
  public String toStringID29(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 30
  public String toStringID30(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 31
  public String toStringID31(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 32
  public String toStringID32(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 33
  public String toStringID33(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 34
  public String toStringID34(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 35
  public String toStringID35(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 36
  public String toStringID36(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
  ...
  // Mutant ID 37
  public String toStringID37(int depth) {
    switch (this.typeNumber) {
      case 0:
        return getTabs(depth) +
                "if (" + expr.toString() + ")\n" +
